	...
	$(function(){ //dom(document object model) tree
		...
		$('#b2').click(function(){
			$.ajax({
				...
				success: function(result){
					$('#d1').append("<img style='width:30px;' src='https://img.freepik.com/free-vector/yellow-emoji-icon-shocked-face-with-emoticon-chat-comment-reaction-emotes_399089-678.jpg?size=338&ext=jpg'>")
					$('#d1').append(result+"<br>")
				} ,
				error: function(){
					alert('ajax 실패.@@')
...
<div id="d1"></div>
<hr>
	가입할 id: <input type="text" name="user" id="user">
